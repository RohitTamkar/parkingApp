...
import 'product_wise_sale_report_model.dart';
export 'product_wise_sale_report_model.dart';

class ProductWiseSaleReportWidget extends StatefulWidget {
  /// Parking
  const ProductWiseSaleReportWidget({
    super.key,
    this.docRef,
  });
  ...
  @override
  State<ProductWiseSaleReportWidget> createState() =>
      _ProductWiseSaleReportWidgetState();
}

class _ProductWiseSaleReportWidgetState
    extends State<ProductWiseSaleReportWidget> {
  late ProductWiseSaleReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductWiseSaleReportModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.productList = await actions.productSaleReport2(
        functions.getDayId(),
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> productWiseSaleReportInvoiceRecordList =
            snapshot.data!;

        return Title(
            title: 'productWiseSaleReport',

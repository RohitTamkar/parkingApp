...
class _VehicleWiseSaleReportWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.invoiceDocus = await queryInvoiceRecordOnce(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> vehicleWiseSaleReportInvoiceRecordList =
            snapshot.data!;
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Builder(
                                                    builder: (context) {
                                                      final twoWheelerListItem = _model
                                                              .invoiceDocus
                                                              ?.where((e) =>
                                                                  e.vechicleType ==
                                                                  'TWO WHEELER')
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemCount:
                                                            twoWheelerListItem
                                                                .length,
                                                        itemBuilder: (context,
                                                            twoWheelerListItemIndex) {
                                                          final twoWheelerListItemItem =
                                                              twoWheelerListItem[
                                                                  twoWheelerListItemIndex];
                                                          return Padding(
                                                            padding:
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            twoWheelerListItemItem.vechicleNo,
                                                                            style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                  fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                                  letterSpacing: 0.0,
                                                                                  fontWeight: FontWeight.w600,
                                                                          ...
                                                                          Text(
                                                                            twoWheelerListItemItem.finalBillAmt.toString(),
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                '${twoWheelerListItemItem.duration.toString()} Hrs',
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                      fontSize: 12.0,
                                                                                      letterSpacing: 0.0,
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                functions.getDayIdAndTime(twoWheelerListItemItem.checkInTime),
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                      fontSize: 12.0,
                                                                                      letterSpacing: 0.0,
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                functions.getDayIdAndTime(twoWheelerListItemItem.checkOutTime),
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                      fontSize: 12.0,
                                                                                      letterSpacing: 0.0,
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Builder(
                                                    builder: (context) {
                                                      final threeWheelerListItem = _model
                                                              .invoiceDocus
                                                              ?.where((e) =>
                                                                  e.vechicleType ==
                                                                  'THREE WHEELER')
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Builder(
                                                    builder: (context) {
                                                      final fourWheelerListItem = _model
                                                              .invoiceDocus
                                                              ?.where((e) =>
                                                                  e.vechicleType ==
                                                                  'FOUR WHEELER')

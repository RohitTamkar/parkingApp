                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    await showDialog(
                                                                                      ...
                                                                                      builder: (alertDialogContext) {
                                                                                        return AlertDialog(
                                                                                          content: Text(FFAppState().currentMobileString),
                                                                                          actions: [
                                                                                            TextButton(
                                                                                          ...
                                                                                          context.pushNamed(
                                                                                            ...
                                                                                            queryParameters: {
                                                                                              ...
                                                                                              'mobile': serializeParam(
                                                                                                valueOrDefault(currentUserDocument?.mobile, ''),
                                                                                                ParamType.String,
                                                                                              ),
                                                                                            }.withoutNulls,
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: AutoSizeText(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '5kha7alq' /* Subscription Due Date */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                      ...
                                      text: TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              '3nf62p4j' /* SENSIBLE CONNECT SOLUTIONS PRI... */,
                                            ),
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                          ...
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'jng2t6e9' /* 2024 All rights reserved */,
                                            ),
                                            style: TextStyle(),
                                          )
                                        ],

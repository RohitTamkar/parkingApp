...
import 'vehicle_entry_widget.dart' show VehicleEntryWidget;
...
class VehicleEntryModel extends FlutterFlowModel<VehicleEntryWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in VehicleEntry widget.
  List<InvoiceRecord>? listcars3;
  // Stores action output result for [Custom Action - scanPrinter] action in VehicleEntry widget.
  bool? resDevice2Copy;
  // Stores action output result for [Custom Action - connectDevice] action in VehicleEntry widget.

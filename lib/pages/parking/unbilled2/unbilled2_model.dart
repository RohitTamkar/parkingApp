...
class Unbilled2Model extends FlutterFlowModel<Unbilled2Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Custom Action - genExcelForUnbillReport] action in IconButton widget.
  String? base64Link2;

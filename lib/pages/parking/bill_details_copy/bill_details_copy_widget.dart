  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> billDetailsCopyInvoiceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final billDetailsCopyInvoiceRecord =
            billDetailsCopyInvoiceRecordList.isNotEmpty
                ? billDetailsCopyInvoiceRecordList.first
                : null;
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              containerInvoiceRecord?.count?.toString(),
                                                                              '-',
                                                                            ),
                                                                            style:
                                                                                TextStyle(),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: TextFormField(
                                                                                controller: _model.textController1 ??= TextEditingController(
                                                                                  text: containerInvoiceRecord?.vechicleNo,
                                                                                ),
                                                                                ...
                                                                                decoration: InputDecoration(
                                                                                  isDense: true,
                                                                                  labelText: containerInvoiceRecord?.advancePaid?.toString(),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: TextFormField(
                                                                                controller: _model.textController2 ??= TextEditingController(
                                                                                  text: containerInvoiceRecord?.finalBillAmt?.toString(),
                                                                                ),
                                                                                ...
                                                                                decoration: InputDecoration(
                                                                                  isDense: true,
                                                                                  labelText: containerInvoiceRecord?.billAmt?.toString(),
                                                                                  labelStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                        letterSpacing: 0.0,
                                                                                        useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).bodyMediumFamily),

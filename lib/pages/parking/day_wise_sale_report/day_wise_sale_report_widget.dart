...
import '/pages/parking/selection_option2/selection_option2_widget.dart';
import 'dart:ui';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ShiftRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ShiftRecord> dayWiseSaleReportShiftRecordList = snapshot.data!;

        return Title(
            title: 'dayWiseSaleReport',
                                              ...
                                              Builder(
                                                builder: (context) =>
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    _model.base64Link222 =
                                                        await actions
                                                            .genExcelForShiftReport(
                                                      functions
                                                          .getCurrentMonth(
                                                              'start')
                                                          .toString(),
                                                      containerOutletRecord
                                                          ?.name,
                                                      dayWiseSaleReportShiftRecordList
                                                          .toList(),
                                                    );

...
import 'edit_outlet_page_model.dart';
export 'edit_outlet_page_model.dart';

class EditOutletPageWidget extends StatefulWidget {
  const EditOutletPageWidget({
    super.key,
    this.outletRef,
    this.id,
    this.docRef,
...
class _EditOutletPageWidgetState extends State<EditOutletPageWidget> {
  late EditOutletPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditOutletPageModel());
    ...
    _model.mErchantTextFieldFocusNode ??= FocusNode();

    _model.merchKeyFocusNode ??= FocusNode();
                                                          ...
                                                          child: StreamBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                ...
                                                                options: dropDownBusinesssMasterRecordList
                                                                    .map((e) =>
                                                                        e.name)
                                                                    .toList(),
                                                                onChanged: (val) =>
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                              .mErchantTextFieldTextController ??=
                                                          TextEditingController(
                                                        text: valueOrDefault<
                                                            String>(
                                                          containerOutletRecord
                                                      ...
                                                      focusNode: _model
                                                          .mErchantTextFieldFocusNode,
                                                      onChanged: (_) =>
                                                          EasyDebounce.debounce(
                                                        '_model.mErchantTextFieldTextController',
                                                        Duration(
                                                            milliseconds: 2000),
                                                        () =>
                                                            safeSetState(() {}),
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      validator: _model
                                                          .merchKeyTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ],
                                                          ...
                                                          builder:
                                                            ...
                                                            return AlertDialog(
                                                              title: Text(
                                                                  'Update Location'),
                                                              content: Text(
                                                                  'Do you want to Update your Outlet location'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
                                      ...
                                      onPressed: () async {
                                        await containerOutletRecord!.reference
                                          ...
                                          merchantId: _model
                                              ...
                                              .text,
                                          merchantKey: _model
                                              .merchKeyTextController.text,
                                          isProd: (_model.mErchantTextFieldTextController
                                                          .text !=
                                                      null &&
                                                  _model.mErchantTextFieldTextController
                                                          .text !=
                                        ...
                                        _model.devieList =
                                          ...
                                          queryBuilder: (deviceRecord) =>
                                            ...
                                            'outletId',
                                            isEqualTo:
                                                containerOutletRecord?.id,
                                          ),
                                        );
                                        FFAppState().updateOutletStartLoop = 0;
                                        safeSetState(() {});
                                        while (

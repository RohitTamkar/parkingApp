...
import 'shift_end_model.dart';
export 'shift_end_model.dart';

class ShiftEndWidget extends StatefulWidget {
...
class _ShiftEndWidgetState extends State<ShiftEndWidget>
    with TickerProviderStateMixin {
  late ShiftEndModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShiftEndModel());
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (confirmDialogResponse) {
                                        await containerShiftRecord!.reference
                                            .update(createShiftRecordData(
                                          endTime: functions.timestampToMili(
                                              getCurrentTimestamp),
                                        ));
                                        await showDialog(
                                          context: context,

...
class CategoryWiseSaleReportWidget extends StatefulWidget {
  /// Parking
  const CategoryWiseSaleReportWidget({super.key});
...
class _CategoryWiseSaleReportWidgetState
    extends State<CategoryWiseSaleReportWidget> {
                                    ...
                                    Builder(
                                      builder: (context) =>
                                        ...
                                        onPressed: () async {
                                          ...
                                          _model.base64LinkCat = await actions
                                              .genExcelForCategoryWiseReport(
                                          ...
                                          _model.apiResult6yc =
                                            ...
                                            toEmail:
                                                FFAppState().emailForReport,
                                            file: _model.base64LinkCat,
                                            fileName: 'categoryWiseReport',
                                            reportType: 'Category Wise Report',
                                          );

                                          if ((_model.apiResult6yc?.succeeded ??
                                              true)) {
                                            await showDialog(
                                              context: context,

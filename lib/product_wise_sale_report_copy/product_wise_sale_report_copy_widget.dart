...
import 'product_wise_sale_report_copy_model.dart';
export 'product_wise_sale_report_copy_model.dart';

class ProductWiseSaleReportCopyWidget extends StatefulWidget {
  /// Parking
  const ProductWiseSaleReportCopyWidget({super.key});

  @override
  State<ProductWiseSaleReportCopyWidget> createState() =>
      _ProductWiseSaleReportCopyWidgetState();
}

class _ProductWiseSaleReportCopyWidgetState
    extends State<ProductWiseSaleReportCopyWidget> {
  late ProductWiseSaleReportCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductWiseSaleReportCopyModel());
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      stream: queryInvoiceRecord(
        ...
        queryBuilder: (invoiceRecord) => invoiceRecord.where(
          'dayId',
          isEqualTo:
              FFAppState().filterDate != '' ? FFAppState().filterDate : null,
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> productWiseSaleReportCopyInvoiceRecordList =
            snapshot.data!;

        return Title(
            title: 'productWiseSaleReportCopy',

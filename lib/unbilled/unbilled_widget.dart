...
import 'unbilled_model.dart';
export 'unbilled_model.dart';

class UnbilledWidget extends StatefulWidget {
  const UnbilledWidget({super.key});

  @override
  State<UnbilledWidget> createState() => _UnbilledWidgetState();
}

class _UnbilledWidgetState extends State<UnbilledWidget> {
  late UnbilledModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnbilledModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> unbilledInvoiceRecordList = snapshot.data!;
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final billWiseSaleReportVar =
                                            unbilledInvoiceRecordList.toList();

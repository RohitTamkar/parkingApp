...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    _safeInit(() {
      _showDiscount = prefs.getBool('ff_showDiscount') ?? _showDiscount;
    });
    _safeInit(() {
      _currentUserRole =
    ...
    _safeInit(() {
      _endDatePass = prefs.getInt('ff_endDatePass') ?? _endDatePass;
    });
    _safeInit(() {
  ...
  set showDiscount(bool value) {
    _showDiscount = value;
    prefs.setBool('ff_showDiscount', value);
  }
  ...
  int _endDatePass = 0;
  int get endDatePass => _endDatePass;
  set endDatePass(int value) {
    _endDatePass = value;
    prefs.setInt('ff_endDatePass', value);
  }

  int _startDatePass = 0;
  int get startDatePass => _startDatePass;
  set startDatePass(int value) {

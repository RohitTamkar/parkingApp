...
import 'web_user_details_report_model.dart';
export 'web_user_details_report_model.dart';

class WebUserDetailsReportWidget extends StatefulWidget {
  /// parking app
  const WebUserDetailsReportWidget({super.key});

  @override
  State<WebUserDetailsReportWidget> createState() =>
      _WebUserDetailsReportWidgetState();
}

class _WebUserDetailsReportWidgetState
    extends State<WebUserDetailsReportWidget> {
  late WebUserDetailsReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebUserDetailsReportModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ShiftRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ShiftRecord> webUserDetailsReportShiftRecordList = snapshot.data!;

        return Title(
            title: 'WebUserDetailsReport',
                                              ...
                                              child: Builder(
                                                builder: (context) {
                                                  final billWiseSaleReportVar =
                                                      webUserDetailsReportShiftRecordList
                                                          .toList();

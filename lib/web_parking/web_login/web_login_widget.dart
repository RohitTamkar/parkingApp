...
class _WebLoginWidgetState extends State<WebLoginWidget> {
  ...
  void initState() {
    ...
    _model.textFieldQuickTextController ??= TextEditingController();
    _model.textFieldQuickFocusNode ??= FocusNode();
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '8h59y96s' /* Manage Billing, Inventory & Fr... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        focusNode:
                                                                            _model.textFieldNumberFocusNode,
                                                                        autofocus:
                                                                            true,
                                                                        obscureText:
                                                                            false,
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            _model.textFieldQuickTextController,
                                                                        focusNode:
                                                                            _model.textFieldQuickFocusNode,
                                                                        autofocus:
                                                                            true,
                                                                        obscureText:
                                                                            !_model.textFieldQuickVisibility,
                                                                        decoration:
                                                                            InputDecoration(
                                                                          isDense:
                                                                              true,
                                                                          ...
                                                                          suffixIcon:
                                                                            ...
                                                                            onTap: () =>
                                                                                safeSetState(
                                                                              () => _model.textFieldQuickVisibility = !_model.textFieldQuickVisibility,
                                                                            ),
                                                                            focusNode:
                                                                                FocusNode(skipTraversal: true),
                                                                            child:
                                                                                Icon(
                                                                              _model.textFieldQuickVisibility ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: Text(
                                                                          'Error'),
                                                                      content: Text(
                                                                          'Enter Valid Mobile No & Quick Pin.'),
                                                                      actions: [
                                                                        TextButton(
                                                                          onPressed: () =>

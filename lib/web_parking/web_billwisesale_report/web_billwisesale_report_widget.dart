...
import 'web_billwisesale_report_model.dart';
export 'web_billwisesale_report_model.dart';

class WebBillwisesaleReportWidget extends StatefulWidget {
  /// parking app
  const WebBillwisesaleReportWidget({super.key});

  @override
  State<WebBillwisesaleReportWidget> createState() =>
      _WebBillwisesaleReportWidgetState();
}

class _WebBillwisesaleReportWidgetState
    extends State<WebBillwisesaleReportWidget> {
  late WebBillwisesaleReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebBillwisesaleReportModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> webBillwisesaleReportInvoiceRecordList =
            snapshot.data!;

        return Title(
            title: 'WebBillwisesaleReport',
                          ...
                          onPressed: () async {
                            ...
                            if (_model.printer!) {
                              await actions.printbillsummaryReport(
                                ...
                                webBillwisesaleReportInvoiceRecordList
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            billWiseSaleReportVarItem.count.toString(),
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            billWiseSaleReportVarItem.vechicleNo,
                                                                            style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                  fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                                  letterSpacing: 0.0,
                                                                                  useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelLargeFamily),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            dateTimeFormat(
                                                                              "d/M/y",
                                                                              DateTime.fromMillisecondsSinceEpoch(billWiseSaleReportVarItem.checkOutTime),
                                                                              locale: FFLocalizations.of(context).languageCode,
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                  fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              billWiseSaleReportVarItem.finalBillAmt.toString(),
                                                                              style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                                    letterSpacing: 0.0,
                                                                                    useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelLargeFamily),

...
import 'web_addproduct_a_p_p_model.dart';
export 'web_addproduct_a_p_p_model.dart';

class WebAddproductAPPWidget extends StatefulWidget {
  const WebAddproductAPPWidget({
    super.key,
    this.catcodeLen,
    this.proRef,
  });
  ...
  @override
  State<WebAddproductAPPWidget> createState() => _WebAddproductAPPWidgetState();
}

class _WebAddproductAPPWidgetState extends State<WebAddproductAPPWidget> {
  late WebAddproductAPPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebAddproductAPPModel());
    ...
    _model.textFieldBaseRateTextController ??= TextEditingController();
    _model.textFieldBaseRateFocusNode ??= FocusNode();

    _model.textFieldBaseDurationTextController ??= TextEditingController();
    _model.textFieldBaseDurationFocusNode ??= FocusNode();

    _model.textFieldHourlyRateTextController ??= TextEditingController();
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            _model.textFieldPurchasePriceTextController,
                                                                        focusNode:
                                                                            _model.textFieldPurchasePriceFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        obscureText:
                                                                            false,
                                                                ...
                                                                return FlutterFlowDropDown<
                                                                  ...
                                                                  controller: _model
                                                                      ...
                                                                      FormFieldController<
                                                                              String>(
                                                                          null),
                                                                  options: dropDownSubCategorySubCategoryRecordList
                                                                      .map((e) =>
                                                                          e.name)
                                                                      .toList(),
                                                                  onChanged: (val) =>
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                ...
                                                                controller: _model
                                                                    ...
                                                                    FormFieldController<
                                                                            String>(
                                                                        null),
                                                                options: dropDownServicePointServicePointOutletRecordList
                                                                    .map((e) =>
                                                                        e.name)
                                                                    .toList(),
                                                                onChanged: (val) =>
                                                                      ...
                                                                      if (!_model
                                                                        ...
                                                                        await productRecordReference
                                                                          ...
                                                                          parkingCharges:
                                                                            ...
                                                                            baseRate:
                                                                                double.tryParse(_model.textFieldBaseRateTextController.text),
                                                                            baseDuration:
                                                                                double.tryParse(_model.textFieldBaseDurationTextController.text),
                                                                            hourlyRate:
                                                                                double.tryParse(_model.textFieldHourlyRateTextController.text),
                                                                            freeMinutes:
                                                                                int.tryParse(_model.textFieldFreeMinutesTextController.text),
                                                                            clearUnsetFields:
                                                                                false,
                                                                            create:
                                                                                true,
                                                                        ...
                                                                        _model.proDoc = ProductRecord.getDocumentFromData(
                                                                            createProductRecordData(
                                                                              ...
                                                                              regionalName: functions.toCapitalLetter1(valueOrDefault<String>(
                                                                                _model.textFieldRegionalNameTextController.text,
                                                                                'NA',
                                                                              )),
                                                                              ...
                                                                              categoryRef: functions.getCatDocRefFromIdCategory(_model.catDoc?.id, FFAppState().outletIdRef),
                                                                              productMasterRef: _model.productDoc?.reference,
                                                                              name: _model.productDropDownValue,
                                                                              weightable: _model.wightCheckboValue,
                                                                              stockable: _model.stockCheckboxValue,
                                                                              type: 0,
                                                                              ...
                                                                              imageUrl: _model.productDoc?.imageUrl,
                                                                            ),

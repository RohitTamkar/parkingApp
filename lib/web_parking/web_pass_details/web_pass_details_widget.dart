...
import 'web_pass_details_model.dart';
export 'web_pass_details_model.dart';

class WebPassDetailsWidget extends StatefulWidget {
  const WebPassDetailsWidget({super.key});

  @override
  State<WebPassDetailsWidget> createState() => _WebPassDetailsWidgetState();
}

class _WebPassDetailsWidgetState extends State<WebPassDetailsWidget> {
  late WebPassDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebPassDetailsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OutletRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OutletRecord> webPassDetailsOutletRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final webPassDetailsOutletRecord =
            webPassDetailsOutletRecordList.isNotEmpty
                ? webPassDetailsOutletRecordList.first
                : null;

        return Title(
            title: 'WebPassDetails',

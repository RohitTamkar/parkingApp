...
import 'web_unbilled_receipts_model.dart';
export 'web_unbilled_receipts_model.dart';

class WebUnbilledReceiptsWidget extends StatefulWidget {
  /// Parking
  const WebUnbilledReceiptsWidget({super.key});

  @override
  State<WebUnbilledReceiptsWidget> createState() =>
      _WebUnbilledReceiptsWidgetState();
}

class _WebUnbilledReceiptsWidgetState extends State<WebUnbilledReceiptsWidget> {
  late WebUnbilledReceiptsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebUnbilledReceiptsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<InvoiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRecord> webUnbilledReceiptsInvoiceRecordList =
            snapshot.data!;

        return Title(
            title: 'WebUnbilledReceipts',
                  ...
                  child: FloatingActionButton.extended(
                    ...
                    label: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        ...
                        _shouldSetState = true;
                        if (_model.printer!) {
                          await actions.printUnbilledReport(
                            FFAppState().printerDevice,
                            FFAppState().isPrinterConnected,
                            FFAppState().printerName,
                            FFAppState().paperSize,
                            webUnbilledReceiptsInvoiceRecordList.toList(),
                          );
                        } else {
                          await showDialog(
                            context: context,
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final billWiseSaleReportVar =
                                                  webUnbilledReceiptsInvoiceRecordList
                                                      .toList();
                                              ...
                                              return ListView.builder(
                                                ...
                                                itemCount: billWiseSaleReportVar
                                                    .length,
                                                itemBuilder: (context,

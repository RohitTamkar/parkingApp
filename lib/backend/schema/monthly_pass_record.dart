...
class MonthlyPassRecord extends FirestoreRecord {
  ...
  // "passStartDayId" field.
  String? _passStartDayId;
  String get passStartDayId => _passStartDayId ?? '';
  bool hasPassStartDayId() => _passStartDayId != null;

  // "passEndDayId" field.
  String? _passEndDayId;
  String get passEndDayId => _passEndDayId ?? '';
  bool hasPassEndDayId() => _passEndDayId != null;
  ...
  void _initializeFields() {
    ...
    _passStartDayId = snapshotData['passStartDayId'] as String?;
    _passEndDayId = snapshotData['passEndDayId'] as String?;
...
Map<String, dynamic> createMonthlyPassRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'passStartDayId': passStartDayId,
      'passEndDayId': passEndDayId,
...
class MonthlyPassRecordDocumentEquality implements Equality<MonthlyPassRecord> {
  ...
  bool equals(MonthlyPassRecord? e1, MonthlyPassRecord? e2) {
    return e1?.id == e2?.id &&
        ...
        e1?.passStartDayId == e2?.passStartDayId &&
        e1?.passEndDayId == e2?.passEndDayId &&
